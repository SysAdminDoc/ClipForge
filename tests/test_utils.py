"""Tests for utility functions in clipforge.py."""
import sys
import os

sys.path.insert(0, os.path.dirname(os.path.dirname(os.path.abspath(__file__))))

# We can't import clipforge directly because it bootstraps PyQt6 on import.
# Instead we extract the pure functions by exec'ing only the parts we need.
import re
import json
